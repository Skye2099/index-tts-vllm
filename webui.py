...
function playAudio(audioPath) {
    ...
    audioElement.addEventListener('error', function(e) {
        ...
        outputContainer.innerHTML = '<p>音频加载失败，请重试</p>';
    });
...
async def gen_single(prompts, text, progress=gr.Progress()):
    ...
    return output_path, gr.update(visible=True), f"<script>playAudio('{output_path}');</script>"
...
<a href='https://arxiv.org/abs/2502.05512'><img src='https://img.shields.io/badge/ArXiv-2502.05512-red'></a>
    ...
    with gr.Tab("音频生成"):
        with gr.Row():
            ...
            # 创建一个容器用于放置音频元素
            output_audio_container = gr.HTML(elem_id="output-audio-container")
            # 保留原有的音频组件用于显示和下载
    ...
    gen_button.click(
        ...
        outputs=[output_audio, output_audio, js_output]
    )
